...
The manually selected `shoulder_abduction` workflow uses front-view 2D geometry, lowered–raised–lowered repetition counting, a fail-closed validity gate, explainable scoring, and safe observational feedback. Shared overlay, report, frame-data, and session options remain available. No shoulder-abduction ML model was trained or promoted.
