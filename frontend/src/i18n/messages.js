...
export const MESSAGES = {
  en: {
    ...
    "exercises.description": "Five rule-based analyzers are available. Manual selection remains primary; planned exercises cannot be analyzed yet.",
    ...
    "coach.eyebrow": "Disabled feature spike",
    "coach.title": "Real-time coaching technical spike",
    "coach.description": "A local-only camera experiment for measuring capture, visibility, and latency before any coaching feature is considered.",
  ...
  ar: {
    ...
    "exercises.description": "تتوفر خمسة محللات قائمة على القواعد. يظل الاختيار اليدوي هو الأساس؛ التمارين المخطط لها غير قابلة للتحليل بعد.",
    ...
    "coach.eyebrow": "تجربة تقنية معطلة افتراضيا",
    "coach.title": "تجربة تقنية للتدريب اللحظي",
    "coach.description": "تجربة كاميرا محلية فقط لقياس الالتقاط والظهور والزمن قبل التفكير في أي ميزة تدريب.",
