...
export const MESSAGES = {
  en: {
    ...
    "nav.careTeam": "My care team",
    "nav.connections": "Care connections",
    "nav.assignments": "Patient assignments",
  ...
  ar: {
    ...
    "nav.careTeam": "فريق رعايتي",
    "nav.connections": "روابط الرعاية",
    "nav.assignments": "تعيين المرضى",
