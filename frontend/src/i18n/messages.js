...
export const MESSAGES = {
  en: {
    ...
    "exercises.description":
      "Twelve rule-based analyzers are available. Manual selection remains primary; planned exercises cannot be analyzed yet.",
  ...
  ar: {
    ...
    "exercises.description":
      "يتوفر اثنا عشر محللا قائما على القواعد. يظل الاختيار اليدوي هو الأساس؛ التمارين المخطط لها غير قابلة للتحليل بعد.",
