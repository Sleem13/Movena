...
export const MESSAGES = {
  en: {
    "upload.subjectSwitch": "More than one person may have been tracked. Record only the person being analyzed, keep coaches and bystanders outside the frame, and try again.",
    ...
    "options.mlDescription": "Add the optional experimental baseline output.",
    ...
    "exercises.description": "Eight rule-based analyzers are available. Manual selection remains primary; planned exercises cannot be analyzed yet.",
    "exercises.researchTitle": "Exercise coaching expansion is in research",
    "exercises.researchDescription": "Pose-data preparation and a versioned XGBoost recognition path are implemented. Push-up, shoulder-press, and bicep-curl analyzers have conservative development paths; hammer-curl grip verification remains in research.",
    ...
    "coach.landmarksDisabled": "No local landmark extractor is attached. Coaching feedback stays disabled.",
    "coach.landmarksEnabled": "Local landmark extractor attached: {count} landmarks, average confidence {confidence}.",
    ...
    "coach.stepAnalyzers": "Conservative push-up, shoulder-press, and bicep-curl analyzers implemented; hammer-curl grip evidence pending",
  ...
  ar: {
    "upload.subjectSwitch": "ربما تم تتبع أكثر من شخص. صوّر الشخص المراد تحليله فقط، وأبقِ المدرب والمارة خارج الإطار، ثم حاول مرة أخرى.",
    ...
    "options.mlDescription": "إضافة مخرجات خط أساس تجريبية اختيارية.",
    ...
    "exercises.description": "تتوفر ثمانية محللات قائمة على القواعد. يظل الاختيار اليدوي هو الأساس؛ التمارين المخطط لها غير قابلة للتحليل بعد.",
    "exercises.researchTitle": "توسع التدريب على التمارين قيد البحث",
    "exercises.researchDescription": "تم تنفيذ إعداد بيانات الوضعية ومسار XGBoost للتعرف. تتوفر مسارات تطوير محافظة للضغط وضغط الكتف وثني الذراع، بينما يظل التحقق من قبضة المطرقة قيد البحث.",
    ...
    "coach.landmarksDisabled": "لا يوجد مستخرج معالم محلي متصل. تبقى ملاحظات التدريب معطلة.",
    "coach.landmarksEnabled": "مستخرج المعالم المحلي متصل: {count} معالم، متوسط الثقة {confidence}.",
    ...
    "coach.stepAnalyzers": "تم تنفيذ محللات محافظة للضغط وضغط الكتف وثني الذراع، ودليل قبضة المطرقة قيد الانتظار",
