...
export default function Results({ report, originalVideoUrl, onAnalyzeAnother, onGoAnalyze, onViewHistory }) {
  ...
  const displayNames = { bodyweight_squat: "Bodyweight squat", sit_to_stand: "Sit-to-Stand", knee_extension: "Knee Extension", shoulder_abduction: "Shoulder Abduction" };
  const movementNames = { bodyweight_squat: "squat", sit_to_stand: "sit-to-stand", knee_extension: "knee-extension", shoulder_abduction: "shoulder-abduction" };
