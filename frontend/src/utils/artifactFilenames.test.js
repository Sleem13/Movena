...
describe("artifactFilename", () => {
  it("names each artifact after its exercise", () => {
    expect(artifactFilename("walking_gait_screen", "overlay")).toBe("physiovision-walking-gait-screen-overlay.webm");
  ...
  it("sanitizes unknown labels and falls back to movement", () => {
    ...
    expect(artifactFilename("", "overlay")).toBe("physiovision-movement-overlay.webm");
  });
});
