# Movena rebuild status — 2026-09-13

**Partial implementation: connected recovery, accounts, plans, health profile, inbox, history, scheduling and visit-note clients; verified Android debug APK.**
...
1. **Complete the application journeys.** Profile/identity settings beyond the patient health fields,
   approved policy content and consent changes, data-rights requests, progress
