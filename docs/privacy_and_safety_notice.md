...
During private staging and closed pilot preparation, users should not upload real patient data unless privacy, consent, and security approval are in place.

Test videos should be non-sensitive and used only for product validation.

## User Responsibility

Users should stop using the system if they experience pain, dizziness, discomfort, or any unsafe movement condition.

For medical concerns, users should consult a licensed healthcare professional.
