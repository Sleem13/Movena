...
Invited adults who can follow the test-only data rules and are not using the app for patient care, diagnosis, treatment, emergency support, or medical decisions. Do not participate on behalf of a patient or upload another person’s identifiable recording.
...
- Open the library and camera guidance.
- Test only bodyweight squat, sit-to-stand, knee extension, shoulder abduction, or hip abduction.
