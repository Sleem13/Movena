...
export default function LimitationsScreen() {
  return <Screen>
    ...
    <Card tone="warning"><Heading>Not medical advice</Heading><Body>This beta is not a medical device and is not for diagnosis, treatment prescription, emergency use, or medical decisions. Rule-based analysis remains primary; ML/DL and recognition are experimental.</Body></Card>
