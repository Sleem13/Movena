...
export default function ExerciseDetailScreen() {
  ...
  if (!exercise.supported_in_app) return <Screen>
    ...
    <Title>{exercise.display_name}</Title><ExerciseAvatar id={exercise.exercise_id} label={exercise.display_name} width={280} /><Body muted>{exercise.body_region} · {exercise.exercise_family}</Body>
