...
export default function SessionHistoryScreen() {
  ...
  if (!user) return <AppShell active="progress"><BrandHeader title="Progress & activity" subtitle="Your saved exercise activity appears here." /><View style={styles.loginState}><View style={styles.largeIcon}><Ionicons name="lock-closed-outline" size={34} color={colors.primary} /></View><Heading>Log in to view progress</Heading><Body muted>Protected rehabilitation activity is available only to your account.</Body><PrimaryButton title="Log in" onPress={() => router.push("/login")} /></View></AppShell>;
