...
const FRIENDLY_MESSAGES: Record<string, string> = {
  ...
  NETWORK_ERROR: "Cannot reach Movena. Check the backend address and Wi-Fi connection, then retry.",
  TIMEOUT: "The request timed out. Try a shorter recording and check your connection.",
  SERVER_UNAVAILABLE: "Movena is temporarily unavailable. Please retry shortly.",
